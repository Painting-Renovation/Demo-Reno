...
const seasonConfig: Record<string, { color: string; bg: string; border: string; icon: typeof Flower2 }> = {
  Spring: { color: 'text-green-600', bg: 'bg-green-50', border: 'border-green-200', icon: Flower2 },
  Summer: { color: 'text-amber-600', bg: 'bg-amber-50', border: 'border-amber-200', icon: Sun },
  Fall: { color: 'text-orange-600', bg: 'bg-orange-50', border: 'border-orange-200', icon: Leaf },
  Winter: { color: 'text-blue-600', bg: 'bg-blue-50', border: 'border-blue-200', icon: Snowflake },
};
          ...
          {tips.map((tip) => {
            ...
            return (
              <motion.article
                ...
                className="bg-white rounded-xl border border-gray-100 p-6 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group flex flex-col"
              >
                {/* Season badge + icon */}
                ...
                <div className="flex items-center justify-between pt-4 border-t border-gray-50">
                  ...
                  <span className="text-xs font-semibold text-gold flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    Read More
